...
class TestCartAddItem:
    ...
    def test_add_nonexistent_product(self, api_client: APIClient) -> None:
        response = api_client.post(
            "/api/cart/items/",
            {
...
class TestCartUpdateItem:
    ...
    def test_update_nonexistent_item(self, api_client: APIClient) -> None:
        response = api_client.patch(
...
class TestCartSubmit:
    ...
    def test_submit_empty_cart(self, api_client: APIClient) -> None:
        response = api_client.post("/api/cart/submit/")
